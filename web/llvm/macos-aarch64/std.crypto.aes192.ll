...
entry:
  ...
  %6 = insertvalue %"char[]" %5, i64 24, 1, !dbg !71
  ...
  %8 = load i32, ptr getelementptr inbounds (i8, ptr getelementptr inbounds (i8, ptr @"std.crypto.aes.AesType$key", i32 32), i64 8), align 8, !dbg !76
...
assert_fail:                                      ; preds = %entry
  ...
  call void %12([2 x i64] %9, [2 x i64] %10, [2 x i64] %11, i32 37) #3, !dbg !73
  unreachable, !dbg !73
...
assert_ok:                                        ; preds = %entry
  ...
  %15 = call ptr @std.crypto.aes.Aes.init(ptr %aes, i32 1, [2 x i64] %13, [2 x i64] %14, i32 2), !dbg !73
...
assert_fail7:                                     ; preds = %expr_block.exit
  ...
  call void %29([2 x i64] %26, [2 x i64] %27, [2 x i64] %28, i32 39) #3, !dbg !86
  unreachable, !dbg !86
...
; Function Attrs: nounwind ssp uwtable(sync)
define weak [2 x i64] @std.crypto.aes192.tencrypt(ptr %0, [2 x i64] %1, [2 x i64] %2) #0 !dbg !91 {
entry:
  %key = alloca ptr, align 8
  %iv = alloca [16 x i8], align 1
  %data = alloca %"char[]", align 8
  ...
  %8 = call [2 x i64] @std.crypto.aes192.encrypt([2 x i64] %4, ptr %5, [2 x i64] %6, [2 x i64] %7), !dbg !102
...
; Function Attrs: nounwind ssp uwtable(sync)
define weak [2 x i64] @std.crypto.aes192.decrypt([2 x i64] %0, ptr %1, [2 x i64] %2, [2 x i64] %3) #0 !dbg !103 {
entry:
  %allocator = alloca %any, align 8
  %key = alloca ptr, align 8
  %iv = alloca [16 x i8], align 1
  ...
  %6 = insertvalue %"char[]" %5, i64 24, 1, !dbg !114
  ...
  %8 = load i32, ptr getelementptr inbounds (i8, ptr getelementptr inbounds (i8, ptr @"std.crypto.aes.AesType$key", i32 32), i64 8), align 8, !dbg !119
...
assert_fail:                                      ; preds = %entry
  ...
  %11 = load [2 x i64], ptr %taddr3, align 8
  %12 = load ptr, ptr @std.core.builtin.panic, align 8
  call void %12([2 x i64] %9, [2 x i64] %10, [2 x i64] %11, i32 50) #3, !dbg !116
  unreachable, !dbg !116
...
assert_ok:                                        ; preds = %entry
  ...
  %13 = load [2 x i64], ptr %taddr4, align 8
  %14 = load [2 x i64], ptr %iv, align 1
  %15 = call ptr @std.crypto.aes.Aes.init(ptr %aes, i32 1, [2 x i64] %13, [2 x i64] %14, i32 2), !dbg !116
...
assert_fail7:                                     ; preds = %expr_block.exit
  ...
  %28 = load [2 x i64], ptr %taddr10, align 8
  %29 = load ptr, ptr @std.core.builtin.panic, align 8
  call void %29([2 x i64] %26, [2 x i64] %27, [2 x i64] %28, i32 52) #3, !dbg !128
  unreachable, !dbg !128
...
; Function Attrs: nounwind ssp uwtable(sync)
define weak [2 x i64] @std.crypto.aes192.tdecrypt(ptr %0, [2 x i64] %1, [2 x i64] %2) #0 !dbg !133 {
entry:
  %key = alloca ptr, align 8
  %iv = alloca [16 x i8], align 1
  %data = alloca %"char[]", align 8
  ...
  %8 = call [2 x i64] @std.crypto.aes192.decrypt([2 x i64] %4, ptr %5, [2 x i64] %6, [2 x i64] %7), !dbg !142
  store [2 x i64] %8, ptr %result, align 8
  %9 = load [2 x i64], ptr %result, align 8
  ret [2 x i64] %9
}
...
!42 = distinct !DISubprogram(name: "encrypt", linkageName: "std.crypto.aes192.encrypt", scope: !7, file: !7, line: 34, type: !43, scopeLine: 34, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !6, retainedNodes: !60)
...
!60 = !{}
!61 = !DILocalVariable(name: "allocator", arg: 1, scope: !42, file: !7, line: 34, type: !50)
!62 = !DILocation(line: 34, column: 29, scope: !42)
!63 = !DILocalVariable(name: "key", arg: 2, scope: !42, file: !7, line: 34, type: !56)
!64 = !DILocation(line: 34, column: 50, scope: !42)
!65 = !DILocalVariable(name: "iv", arg: 3, scope: !42, file: !7, line: 34, type: !25)
!66 = !DILocation(line: 34, column: 75, scope: !42)
!67 = !DILocalVariable(name: "data", arg: 4, scope: !42, file: !7, line: 34, type: !45)
!68 = !DILocation(line: 34, column: 86, scope: !42)
!69 = !DILocalVariable(name: "aes", scope: !42, file: !7, line: 36, type: !10, align: 64)
!70 = !DILocation(line: 36, column: 6, scope: !42)
!71 = !DILocation(line: 37, column: 19, scope: !42)
!72 = !DILocalVariable(name: "iv", scope: !42, file: !7, line: 37, type: !25, align: 8)
!73 = !DILocation(line: 37, column: 2, scope: !42)
!74 = !DILocation(line: 37, column: 24, scope: !42)
!75 = !DILocation(line: 102, column: 11, scope: !42)
!76 = !DILocation(line: 102, column: 22, scope: !42)
!77 = !DILocation(line: 39, column: 21, scope: !42)
!78 = !DILocation(line: 39, column: 32, scope: !42)
...
!86 = !DILocation(line: 39, column: 9, scope: !42)
!87 = !DILocation(line: 130, column: 11, scope: !88, inlinedAt: !86)
!88 = distinct !DILexicalBlock(scope: !84, file: !83, line: 130, column: 4)
!89 = !DILocation(line: 38, column: 8, scope: !90)
!90 = distinct !DILexicalBlock(scope: !42, file: !7, line: 38, column: 8)
!91 = distinct !DISubprogram(name: "tencrypt", linkageName: "std.crypto.aes192.tencrypt", scope: !7, file: !7, line: 42, type: !92, scopeLine: 42, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !6, retainedNodes: !60)
!92 = !DISubroutineType(types: !93)
!93 = !{!45, !56, !25, !45}
!94 = !DILocalVariable(name: "key", arg: 1, scope: !91, file: !7, line: 42, type: !56)
!95 = !DILocation(line: 42, column: 30, scope: !91)
!96 = !DILocalVariable(name: "iv", arg: 2, scope: !91, file: !7, line: 42, type: !25)
!97 = !DILocation(line: 42, column: 55, scope: !91)
!98 = !DILocalVariable(name: "data", arg: 3, scope: !91, file: !7, line: 42, type: !45)
!99 = !DILocation(line: 42, column: 66, scope: !91)
!100 = !DILocation(line: 44, column: 17, scope: !91)
!101 = !DILocation(line: 44, column: 32, scope: !91)
!102 = !DILocation(line: 44, column: 9, scope: !91)
!103 = distinct !DISubprogram(name: "decrypt", linkageName: "std.crypto.aes192.decrypt", scope: !7, file: !7, line: 47, type: !43, scopeLine: 47, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !6, retainedNodes: !60)
!104 = !DILocalVariable(name: "allocator", arg: 1, scope: !103, file: !7, line: 47, type: !50)
!105 = !DILocation(line: 47, column: 29, scope: !103)
!106 = !DILocalVariable(name: "key", arg: 2, scope: !103, file: !7, line: 47, type: !56)
!107 = !DILocation(line: 47, column: 50, scope: !103)
!108 = !DILocalVariable(name: "iv", arg: 3, scope: !103, file: !7, line: 47, type: !25)
!109 = !DILocation(line: 47, column: 75, scope: !103)
!110 = !DILocalVariable(name: "data", arg: 4, scope: !103, file: !7, line: 47, type: !45)
!111 = !DILocation(line: 47, column: 86, scope: !103)
!112 = !DILocalVariable(name: "aes", scope: !103, file: !7, line: 49, type: !10, align: 64)
!113 = !DILocation(line: 49, column: 6, scope: !103)
!114 = !DILocation(line: 50, column: 19, scope: !103)
!115 = !DILocalVariable(name: "iv", scope: !103, file: !7, line: 50, type: !25, align: 8)
!116 = !DILocation(line: 50, column: 2, scope: !103)
!117 = !DILocation(line: 50, column: 24, scope: !103)
!118 = !DILocation(line: 102, column: 11, scope: !103)
!119 = !DILocation(line: 102, column: 22, scope: !103)
!120 = !DILocation(line: 52, column: 21, scope: !103)
!121 = !DILocation(line: 52, column: 32, scope: !103)
...
!128 = !DILocation(line: 52, column: 9, scope: !103)
!129 = !DILocation(line: 130, column: 11, scope: !130, inlinedAt: !128)
!130 = distinct !DILexicalBlock(scope: !126, file: !83, line: 130, column: 4)
!131 = !DILocation(line: 51, column: 8, scope: !132)
!132 = distinct !DILexicalBlock(scope: !103, file: !7, line: 51, column: 8)
!133 = distinct !DISubprogram(name: "tdecrypt", linkageName: "std.crypto.aes192.tdecrypt", scope: !7, file: !7, line: 55, type: !92, scopeLine: 55, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !6, retainedNodes: !60)
!134 = !DILocalVariable(name: "key", arg: 1, scope: !133, file: !7, line: 55, type: !56)
!135 = !DILocation(line: 55, column: 30, scope: !133)
!136 = !DILocalVariable(name: "iv", arg: 2, scope: !133, file: !7, line: 55, type: !25)
!137 = !DILocation(line: 55, column: 55, scope: !133)
!138 = !DILocalVariable(name: "data", arg: 3, scope: !133, file: !7, line: 55, type: !45)
!139 = !DILocation(line: 55, column: 66, scope: !133)
!140 = !DILocation(line: 57, column: 17, scope: !133)
!141 = !DILocation(line: 57, column: 32, scope: !133)
!142 = !DILocation(line: 57, column: 9, scope: !133)
