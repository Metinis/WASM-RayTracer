...
checkok:                                          ; preds = %entry
  ...
  store i32 %1, ptr %seed, align 4
    #dbg_declare(ptr %seed, !26, !DIExpression(), !27)
  %4 = load i32, ptr %seed, align 4, !dbg !28
  %bnot = xor i32 %4, -1, !dbg !28
  %5 = load ptr, ptr %self, align 8, !dbg !29
  store i32 %bnot, ptr %5, align 4, !dbg !29
  ret void, !dbg !29
...
panic:                                            ; preds = %entry
  ...
  call void %9([2 x i64] %6, [2 x i64] %7, [2 x i64] %8, i32 11) #2, !dbg !25
  unreachable, !dbg !25
}
...
checkok:                                          ; preds = %entry
  ...
  %5 = load i32, ptr %4, align 4, !dbg !39
  %lshr = lshr i32 %5, 8, !dbg !39
  %6 = freeze i32 %lshr, !dbg !39
  %7 = load ptr, ptr %self, align 8, !dbg !40
  %8 = load i32, ptr %7, align 4, !dbg !40
  %9 = load i8, ptr %c, align 1, !dbg !41
  %zext = zext i8 %9 to i32, !dbg !41
  %xor = xor i32 %8, %zext, !dbg !40
  %and = and i32 %xor, 255, !dbg !42
  %zext3 = zext i32 %and to i64, !dbg !42
  %ge = icmp uge i64 %zext3, 256, !dbg !42
  %10 = call i1 @llvm.expect.i1(i1 %ge, i1 false), !dbg !42
  br i1 %10, label %panic4, label %checkok11, !dbg !42

checkok11:                                        ; preds = %checkok
  %ptroffset = getelementptr inbounds [4 x i8], ptr @std.hash.crc32.CRC32_TABLE, i64 %zext3, !dbg !42
  %11 = load i32, ptr %ptroffset, align 4, !dbg !42
  %xor12 = xor i32 %6, %11, !dbg !43
  %12 = load ptr, ptr %self, align 8, !dbg !44
  store i32 %xor12, ptr %12, align 4, !dbg !44
  ret void, !dbg !44
...
panic:                                            ; preds = %entry
  ...
  call void %16([2 x i64] %13, [2 x i64] %14, [2 x i64] %15, i32 16) #2, !dbg !36
  unreachable, !dbg !36
...
panic4:                                           ; preds = %checkok
  ...
  call void @std.core.builtin.panicf([2 x i64] %21, [2 x i64] %22, [2 x i64] %23, i32 18, [2 x i64] %25) #2, !dbg !42
  unreachable, !dbg !42
}

; Function Attrs: nounwind ssp uwtable(sync)
define weak void @std.hash.crc32.Crc32.update(ptr %0, [2 x i64] %1) #0 !dbg !45 {
entry:
  %taddr = alloca %"char[]", align 8
  %taddr1 = alloca %"char[]", align 8
  %taddr2 = alloca %"char[]", align 8
...
checkok:                                          ; preds = %entry
  ...
  %5 = load i32, ptr %4, align 4, !dbg !62
  store i32 %5, ptr %result, align 4, !dbg !62
  %ptradd = getelementptr inbounds i8, ptr %data, i64 8, !dbg !63
  %6 = load i64, ptr %ptradd, align 8, !dbg !63
...
loop.cond:                                        ; preds = %checkok26, %checkok
  %7 = load i64, ptr %.anon, align 8, !dbg !63
  %lt = icmp ult i64 %7, %6, !dbg !63
  br i1 %lt, label %loop.body, label %loop.exit, !dbg !63

loop.body:                                        ; preds = %loop.cond
    #dbg_declare(ptr %x, !66, !DIExpression(), !68)
  %ptradd3 = getelementptr inbounds i8, ptr %data, i64 8, !dbg !69
  %8 = load i64, ptr %ptradd3, align 8, !dbg !69
  %9 = load ptr, ptr %data, align 8, !dbg !69
  %10 = load i64, ptr %.anon, align 8, !dbg !69
  %ge = icmp uge i64 %10, %8, !dbg !69
  %11 = call i1 @llvm.expect.i1(i1 %ge, i1 false), !dbg !69
  br i1 %11, label %panic4, label %checkok12, !dbg !69

checkok12:                                        ; preds = %loop.body
  %ptradd13 = getelementptr inbounds i8, ptr %9, i64 %10, !dbg !69
  %12 = load i8, ptr %ptradd13, align 1, !dbg !69
  store i8 %12, ptr %x, align 1, !dbg !69
  %13 = load i32, ptr %result, align 4, !dbg !70
  %lshr = lshr i32 %13, 8, !dbg !70
  %14 = freeze i32 %lshr, !dbg !70
  %15 = load i32, ptr %result, align 4, !dbg !72
  %16 = load i8, ptr %x, align 1, !dbg !73
  %zext = zext i8 %16 to i32, !dbg !73
  %xor = xor i32 %15, %zext, !dbg !72
  %and = and i32 %xor, 255, !dbg !74
  %zext14 = zext i32 %and to i64, !dbg !74
  %ge15 = icmp uge i64 %zext14, 256, !dbg !74
  %17 = call i1 @llvm.expect.i1(i1 %ge15, i1 false), !dbg !74
  br i1 %17, label %panic16, label %checkok26, !dbg !74

checkok26:                                        ; preds = %checkok12
  %ptroffset = getelementptr inbounds [4 x i8], ptr @std.hash.crc32.CRC32_TABLE, i64 %zext14, !dbg !74
  %18 = load i32, ptr %ptroffset, align 4, !dbg !74
  %xor27 = xor i32 %14, %18, !dbg !75
  store i32 %xor27, ptr %result, align 4, !dbg !75
  %19 = load i64, ptr %.anon, align 8, !dbg !63
  %addnuw = add nuw i64 %19, 1, !dbg !63
  store i64 %addnuw, ptr %.anon, align 8, !dbg !63
  br label %loop.cond, !dbg !63

loop.exit:                                        ; preds = %loop.cond
  %20 = load ptr, ptr %self, align 8, !dbg !76
  %21 = load i32, ptr %result, align 4, !dbg !76
  store i32 %21, ptr %20, align 4, !dbg !76
  ret void, !dbg !76
...
panic:                                            ; preds = %entry
  ...
  call void %25([2 x i64] %22, [2 x i64] %23, [2 x i64] %24, i32 21) #2, !dbg !57
  unreachable, !dbg !57
...
panic4:                                           ; preds = %loop.body
  ...
  call void @std.core.builtin.panicf([2 x i64] %30, [2 x i64] %31, [2 x i64] %32, i32 24, [2 x i64] %34) #2, !dbg !69
  unreachable, !dbg !69
...
panic16:                                          ; preds = %checkok12
  ...
  call void @std.core.builtin.panicf([2 x i64] %39, [2 x i64] %40, [2 x i64] %41, i32 26, [2 x i64] %43) #2, !dbg !74
  unreachable, !dbg !74
}

; Function Attrs: nounwind ssp uwtable(sync)
define weak i32 @std.hash.crc32.Crc32.final(ptr %0) #0 !dbg !77 {
entry:
  %taddr = alloca %"char[]", align 8
  %taddr1 = alloca %"char[]", align 8
  %taddr2 = alloca %"char[]", align 8
...
panic:                                            ; preds = %entry
  ...
  call void %8([2 x i64] %5, [2 x i64] %6, [2 x i64] %7, i32 31) #2, !dbg !82
  unreachable, !dbg !82
}

; Function Attrs: nounwind ssp uwtable(sync)
define weak i32 @std.hash.crc32.hash([2 x i64] %0) #0 !dbg !84 {
entry:
  %data = alloca %"char[]", align 8
  %result = alloca i32, align 4
  %.anon = alloca i64, align 8
  ...
  store i32 -1, ptr %result, align 4, !dbg !91
  %ptradd = getelementptr inbounds i8, ptr %data, i64 8, !dbg !92
  %1 = load i64, ptr %ptradd, align 8, !dbg !92
...
loop.cond:                                        ; preds = %checkok21, %entry
  %2 = load i64, ptr %.anon, align 8, !dbg !92
  %lt = icmp ult i64 %2, %1, !dbg !92
...
loop.body:                                        ; preds = %loop.cond
  ...
  %3 = load i64, ptr %ptradd1, align 8, !dbg !98
  %4 = load ptr, ptr %data, align 8, !dbg !98
  %5 = load i64, ptr %.anon, align 8, !dbg !98
  %ge = icmp uge i64 %5, %3, !dbg !98
  %6 = call i1 @llvm.expect.i1(i1 %ge, i1 false), !dbg !98
  br i1 %6, label %panic, label %checkok, !dbg !98

checkok:                                          ; preds = %loop.body
  %ptradd8 = getelementptr inbounds i8, ptr %4, i64 %5, !dbg !98
  %7 = load i8, ptr %ptradd8, align 1, !dbg !98
  store i8 %7, ptr %x, align 1, !dbg !98
  %8 = load i32, ptr %result, align 4, !dbg !99
  %lshr = lshr i32 %8, 8, !dbg !99
  %9 = freeze i32 %lshr, !dbg !99
  %10 = load i32, ptr %result, align 4, !dbg !101
  %11 = load i8, ptr %x, align 1, !dbg !102
  %zext = zext i8 %11 to i32, !dbg !102
  %xor = xor i32 %10, %zext, !dbg !101
  %and = and i32 %xor, 255, !dbg !103
  %zext9 = zext i32 %and to i64, !dbg !103
  %ge10 = icmp uge i64 %zext9, 256, !dbg !103
  %12 = call i1 @llvm.expect.i1(i1 %ge10, i1 false), !dbg !103
  br i1 %12, label %panic11, label %checkok21, !dbg !103

checkok21:                                        ; preds = %checkok
  %ptroffset = getelementptr inbounds [4 x i8], ptr @std.hash.crc32.CRC32_TABLE, i64 %zext9, !dbg !103
  %13 = load i32, ptr %ptroffset, align 4, !dbg !103
  %xor22 = xor i32 %9, %13, !dbg !104
  store i32 %xor22, ptr %result, align 4, !dbg !104
  %14 = load i64, ptr %.anon, align 8, !dbg !92
  %addnuw = add nuw i64 %14, 1, !dbg !92
  store i64 %addnuw, ptr %.anon, align 8, !dbg !92
  br label %loop.cond, !dbg !92

loop.exit:                                        ; preds = %loop.cond
  %15 = load i32, ptr %result, align 4, !dbg !105
  %bnot = xor i32 %15, -1, !dbg !105
  ret i32 %bnot, !dbg !105
...
panic:                                            ; preds = %loop.body
  ...
  call void @std.core.builtin.panicf([2 x i64] %20, [2 x i64] %21, [2 x i64] %22, i32 39, [2 x i64] %24) #2, !dbg !98
  unreachable, !dbg !98
...
panic11:                                          ; preds = %checkok
  ...
  call void @std.core.builtin.panicf([2 x i64] %29, [2 x i64] %30, [2 x i64] %31, i32 41, [2 x i64] %33) #2, !dbg !103
  unreachable, !dbg !103
}
...
!1 = distinct !DIGlobalVariable(name: "CRC32_TABLE", linkageName: "std.hash.crc32.CRC32_TABLE", scope: !2, file: !2, line: 46, type: !3, isLocal: true, isDefinition: true, align: 32)
!2 = !DIFile(filename: "crc32.c3", directory: "/opt/homebrew/Cellar/c3c/0.7.10/lib/c3/std/hash")
...
!28 = !DILocation(line: 13, column: 17, scope: !15)
...
!39 = !DILocation(line: 18, column: 17, scope: !30)
!40 = !DILocation(line: 18, column: 50, scope: !30)
!41 = !DILocation(line: 18, column: 64, scope: !30)
!42 = !DILocation(line: 18, column: 49, scope: !30)
!43 = !DILocation(line: 18, column: 16, scope: !30)
!44 = !DILocation(line: 18, column: 2, scope: !30)
!45 = distinct !DISubprogram(name: "update", linkageName: "std.hash.crc32.Crc32.update", scope: !2, file: !2, line: 21, type: !46, scopeLine: 21, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !13, retainedNodes: !22)
...
!51 = !DIDerivedType(tag: DW_TAG_pointer_type, baseType: !33, size: 64, align: 64, dwarfAddressSpace: 0)
...
!55 = !DILocation(line: 22, column: 1, scope: !45)
!56 = !DILocalVariable(name: "self", arg: 1, scope: !45, file: !2, line: 21, type: !18)
!57 = !DILocation(line: 21, column: 22, scope: !45)
!58 = !DILocalVariable(name: "data", arg: 2, scope: !45, file: !2, line: 21, type: !48)
!59 = !DILocation(line: 21, column: 36, scope: !45)
!60 = !DILocalVariable(name: "result", scope: !45, file: !2, line: 23, type: !4, align: 32)
!61 = !DILocation(line: 23, column: 7, scope: !45)
!62 = !DILocation(line: 23, column: 16, scope: !45)
!63 = !DILocation(line: 24, column: 20, scope: !64)
!64 = distinct !DILexicalBlock(scope: !45, file: !2, line: 24, column: 2)
!65 = !DILocalVariable(name: ".temp", scope: !64, file: !2, line: 24, type: !53, align: 64)
!66 = !DILocalVariable(name: "x", scope: !67, file: !2, line: 24, type: !33, align: 8)
...
!72 = !DILocation(line: 26, column: 41, scope: !71)
!73 = !DILocation(line: 26, column: 50, scope: !71)
!74 = !DILocation(line: 26, column: 40, scope: !71)
!75 = !DILocation(line: 26, column: 12, scope: !71)
!76 = !DILocation(line: 28, column: 2, scope: !45)
!77 = distinct !DISubprogram(name: "final", linkageName: "std.hash.crc32.Crc32.final", scope: !2, file: !2, line: 31, type: !78, scopeLine: 31, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !13, retainedNodes: !22)
!78 = !DISubroutineType(types: !79)
!79 = !{!4, !18}
!80 = !DILocation(line: 32, column: 1, scope: !77)
!81 = !DILocalVariable(name: "self", arg: 1, scope: !77, file: !2, line: 31, type: !18)
!82 = !DILocation(line: 31, column: 21, scope: !77)
!83 = !DILocation(line: 33, column: 10, scope: !77)
!84 = distinct !DISubprogram(name: "hash", linkageName: "std.hash.crc32.hash", scope: !2, file: !2, line: 36, type: !85, scopeLine: 36, flags: DIFlagPrototyped, spFlags: DISPFlagDefinition, unit: !13, retainedNodes: !22)
!85 = !DISubroutineType(types: !86)
!86 = !{!4, !48}
!87 = !DILocalVariable(name: "data", arg: 1, scope: !84, file: !2, line: 36, type: !48)
!88 = !DILocation(line: 36, column: 21, scope: !84)
!89 = !DILocalVariable(name: "result", scope: !84, file: !2, line: 38, type: !4, align: 32)
!90 = !DILocation(line: 38, column: 7, scope: !84)
!91 = !DILocation(line: 38, column: 16, scope: !84)
!92 = !DILocation(line: 39, column: 20, scope: !93)
!93 = distinct !DILexicalBlock(scope: !84, file: !2, line: 39, column: 2)
!94 = !DILocalVariable(name: ".temp", scope: !93, file: !2, line: 39, type: !53, align: 64)
!95 = !DILocalVariable(name: "x", scope: !96, file: !2, line: 39, type: !33, align: 8)
...
!101 = !DILocation(line: 41, column: 41, scope: !100)
!102 = !DILocation(line: 41, column: 50, scope: !100)
!103 = !DILocation(line: 41, column: 40, scope: !100)
!104 = !DILocation(line: 41, column: 12, scope: !100)
!105 = !DILocation(line: 43, column: 10, scope: !84)
