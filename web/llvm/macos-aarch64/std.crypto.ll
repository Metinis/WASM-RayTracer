...
entry:
  ...
  store ptr %1, ptr %data2, align 8
    #dbg_declare(ptr %data2, !17, !DIExpression(), !18)
  store i64 %2, ptr %len, align 8
    #dbg_declare(ptr %len, !19, !DIExpression(), !21)
    #dbg_declare(ptr %match, !22, !DIExpression(), !24)
  store i8 0, ptr %match, align 1, !dbg !25
    #dbg_declare(ptr %i, !26, !DIExpression(), !28)
...
!7 = !DIFile(filename: "crypto.c3", directory: "/opt/homebrew/Cellar/c3c/0.7.10/lib/c3/std/crypto")
...
!22 = !DILocalVariable(name: "match", scope: !8, file: !7, line: 5, type: !23, align: 8)
...
!26 = !DILocalVariable(name: "i", scope: !27, file: !7, line: 6, type: !20, align: 64)
...
!35 = distinct !DISubprogram(name: "@volatile_load", linkageName: "@volatile_load", scope: !36, file: !36, line: 228, scopeLine: 228, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !6)
!36 = !DIFile(filename: "mem.c3", directory: "/opt/homebrew/Cellar/c3c/0.7.10/lib/c3/std/core")
...
!40 = distinct !DISubprogram(name: "@volatile_load", linkageName: "@volatile_load", scope: !36, file: !36, line: 228, scopeLine: 228, spFlags: DISPFlagLocalToUnit | DISPFlagDefinition, unit: !6)
